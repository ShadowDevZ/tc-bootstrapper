...
def DownloadSource(uri: str, dest: str, dflags: int=0) -> int:
...
def UnpackSource(src: str, dst: str) -> bool:
    perms = "r:"
...
def CompileTargetBinutils(src: str,prefix: str,target: str, nproc: int) -> None:
...
def CompileTargetGcc(src: str,prefix: str,target: str, nproc: int, tree: str) -> None:
    if (not os.path.exists(src)):
        os.mkdir(src)
